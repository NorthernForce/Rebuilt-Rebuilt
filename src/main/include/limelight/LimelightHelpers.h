...
namespace LimelightHelpers
{
    ...
    inline std::unordered_map<std::string, nt::DoubleArrayEntry>
        doubleArrayEntries;
        ...
        const std::string& tableName, const std::string& entryName)
    {
        ...
        if (it == doubleArrayEntries.end())
        {
            std::shared_ptr<nt::NetworkTable> table =
                getLimelightNTTable(tableName);
            nt::DoubleArrayTopic daTopic =
                table->GetDoubleArrayTopic(entryName);
     ...
     */
    inline const std::string getClassifierClass(
    ...
    inline void setLEDMode_PipelineControl(
        const std::string& limelightName = "")
    {
    ...
    inline void setStreamMode_PiPSecondary(
        const std::string& limelightName = "")
    {
     ...
     */
    inline void setFiducial3DOffset(const std::string& limelightName,
    ...
    inline void SetRobotOrientation(const std::string& limelightName,
                                    double yaw, double yawRate, double pitch,
                                    double pitchRate, double roll,
                                    double rollRate)
    {
        SetRobotOrientation_INTERNAL(limelightName, yaw, yawRate, pitch,
                                     pitchRate, roll, rollRate, true);
    }
     ...
     */
    inline void SetFidcuial3DOffset(const std::string& limelightName, double x,
                                    double y, double z)
    {
        std::array<double, 3> entries;
        entries[0] = x;
    ...
    /**
     * Sets the camera pose in robotspace. The UI camera pose must be set to
     * zeros
     */
    ...
    inline void setPythonScriptData(
        const std::string& limelightName,
                                           ...
                                           bool isMegaTag2)
    {
        ...
        if (poseArray.size() == expectedTotalVals)
        {
            for (int i = 0; i < tagCount; i++)
            {
                ...
                int id =
                    static_cast<int>(extractBotPoseEntry(poseArray, baseIndex));
                ...
                double distToCamera =
                    extractBotPoseEntry(poseArray, baseIndex + 4);
                double distToRobot =
                    extractBotPoseEntry(poseArray, baseIndex + 5);
                double ambiguity =
                    extractBotPoseEntry(poseArray, baseIndex + 6);
                rawFiducials.emplace_back(id, txnc, tync, ta, distToCamera,
                                          distToRobot, ambiguity);
            }
        }

        return PoseEstimate(pose, units::time::second_t(adjustedTimestamp),
                            latency, tagCount, tagSpan, tagDist, tagArea,
     ...
     * IMU data is formatted as [robotYaw, Roll, Pitch, Yaw, gyroX, gyroY,
     * gyroZ, accelX, accelY, accelZ]. Returns all zeros if data is invalid or
     * unavailable.
     *
     * @param limelightName Name/identifier of the Limelight
    ...
    inline IMUData getIMUData(const std::string& limelightName)
    {
        std::vector<double> imuData =
            getLimelightNTDoubleArray(limelightName, "imu");
    ...
    public:
        ...
        // Should these actually use m_TargetXNormalizedCrosshairAdjusted and be
        // part of SingleTargetingResultClass?
    ...
    inline void PhoneHome()
    {
        ...
        if (sockfd == -1)
        {
            ...
            sendto(sockfd, msg, std::strlen(msg), 0,
        ...
        ssize_t n = recvfrom(sockfd, reinterpret_cast<char*>(receiveData), 1024,
    ...
    inline void from_json(const wpi::json& j, RetroreflectiveResultClass& t)
    {
        ...
        t.m_TargetXDegreesCrosshairAdjusted = SafeJSONAccess<double>(
            j, internal::_key_TargetXDegreesCrosshair, 0.0);
        t.m_TargetYDegreesCrosshairAdjusted = SafeJSONAccess<double>(
            j, internal::_key_TargetYDegreesCrosshair, 0.0);
    ...
    {
        t.m_confidence =
            SafeJSONAccess<double>(j, internal::_key_confidence, 0.0);
        t.m_classID = SafeJSONAccess<double>(j, internal::_key_classID, 0.0);
        t.m_className =
            SafeJSONAccess<std::string>(j, internal::_key_className, "");
        t.m_TargetXPixels =
            SafeJSONAccess<double>(j, internal::_key_TargetXPixels, 0.0);
        t.m_TargetYPixels =
            SafeJSONAccess<double>(j, internal::_key_TargetYPixels, 0.0);
    ...
    inline void from_json(const wpi::json& j, BarcodeResultClass& t)
    {
        ...
        t.m_TargetXDegreesNoCrosshairAdjusted = SafeJSONAccess<double>(
            j, internal::_key_TargetXDegreesNoCrosshair, 0.0);
        t.m_TargetYDegreesNoCrosshairAdjusted = SafeJSONAccess<double>(
            j, internal::_key_TargetYDegreesNoCrosshair, 0.0);
        t.m_TargetAreaNormalized =
            SafeJSONAccess<double>(j, internal::_key_TargetAreaNormalized, 0.0);
        t.m_TargetCorners = SafeJSONAccess<std::vector<std::vector<double>>>(
            j, internal::_key_corners, std::vector<std::vector<double>>{});
    ...
    {
        t.m_timeStamp =
            SafeJSONAccess<double>(j, internal::_key_timestamp, 0.0);
        t.m_latencyPipeline =
        ...
        t.botPose = SafeJSONAccess<std::vector<double>>(
            j, internal::_key_botpose, defaultVector);
        ...
        t.RetroResults =
            SafeJSONAccess<std::vector<RetroreflectiveResultClass>>(
    ...
    {
        t.targetingResults =
            SafeJSONAccess<LimelightHelpers::VisionResultsClass>(
