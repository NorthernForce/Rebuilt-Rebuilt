...
TEST_F(ConstantsTest, CameraTransformsValid)
{
    ...
    frc::Transform3d frontLeftTransform = CameraConstants::kFrontLeftCameraTransform;
    frc::Transform3d centerTransform = CameraConstants::kCenterCameraTransform;
    frc::Transform3d frontRightTransform = CameraConstants::kFrontRightCameraTransform;
    frc::Transform3d centerBackTransform = CameraConstants::kCenterBackCameraTransform;
