...
namespace nfr
{
    ...
    private:
        ...
        std::unordered_map<std::string, std::variant<nt::DoublePublisher, nt::IntegerPublisher, nt::BooleanPublisher,
            nt::StringPublisher, nt::DoubleArrayPublisher, nt::IntegerArrayPublisher, nt::BooleanArrayPublisher,
            nt::StringArrayPublisher>> topics;
    };
}