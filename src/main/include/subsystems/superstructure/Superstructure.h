...
public:
    /**
     * @brief A loggable struct consisting of two length values for the heights
     * of the inner and outer elevator stages
     */
     ...
     * Note: This does not actually move the superstructure and is only used for
     * logging. To move the superstructure, use the GoTo- or HoldAt- Position
     * commands
    ...
    /**
     * @brief Converts a SuperstructurePreset to a SuperstructureState with the
     * correct elevator heights
     ...
     * This command ends as soon as the superstructure reaches the desired
     * position
     ...
     * @param innerElevatorSpeed A function that returns a speed value to run
     * the inner elevator at
     * @param outerElevatorSpeed A function that returns a speed value to run
     * the outer elevator at
     */
...
/**
 * @brief A ParallelCommandGroup consisting of two
 * ElevatorMoveToPositionCommands
 */
...
/**
 * @brief A ParallelCommandGroup consisting of two
 * ElevatorHoldAtPositionCommands
 */
...
public:
    /**
     * @param superstructure A pointer to the superstructure being used
     * @param innerElevatorSpeed A function that returns the speed value for the
     * inner elevator
     * @param outerElevatorSpeed A function that returns the speed value for the
     * outer elevator
     */
    SuperstructureManualControlCommand(
        Superstructure* superstructure,
