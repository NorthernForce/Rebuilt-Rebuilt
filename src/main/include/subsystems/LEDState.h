...
namespace nfr
{
     ...
     * 
     * This class defines the interface for all LED states. Each state must implement
     * the Animate method to apply its animation to the CANdle, and the GetStateName
     * method to return a human-readable name for the state.
     */
    class LEDState
    {
    public:
