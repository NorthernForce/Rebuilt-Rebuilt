...
namespace nfr
{
    ...
    struct LEDAnimation
    {
        ctre::phoenix6::controls::BaseStatusSignal::LatencyCompensationStrategy
            latencyCompensation = ctre::phoenix6::controls::BaseStatusSignal::
                LatencyCompensationStrategy::NoCompensation;
        // documentation explains this better than i can
        uint8_t brightness = 255;  // 0-255 vals
        ctre::phoenix6::StatusCode status;

        // animation parameters
        ctre::phoenix6::controls::AnimationType animationType =
            ctre::phoenix6::controls::AnimationType::None;
        int animationSlot = 0;
        uint32_t speed = 1;
        uint8_t ledStripType =
            static_cast<uint8_t>(ctre::phoenix6::hardware::LEDStripType::GRB);
        ...
        std::function<void(ctre::phoenix6::CANdle&)> customAnimationFunction =
            nullptr;
    };
