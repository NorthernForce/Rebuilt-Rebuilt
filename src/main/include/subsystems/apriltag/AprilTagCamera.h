...
namespace nfr
{
     ...
     * while abstracting the underlying camera technology (PhotonVision,
     * LimeLight, etc.)
     */
    ...
    public:
         ...
         * @param io The IO implementation to use (PhotonVision, LimeLight,
         * etc.)
         * @param name Human-readable name for this camera
         */
        AprilTagCamera(std::unique_ptr<AprilTagCameraIO> io,
