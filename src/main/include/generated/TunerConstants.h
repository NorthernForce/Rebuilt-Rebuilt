...
class TunerConstants
{
    ...
    // with the output type specified by
    ...
    // configs
    static constexpr std::optional<configs::Pigeon2Configuration>
...
private:
    ...
    static constexpr units::kilogram_square_meter_t kSteerInertia =
        0.01_kg_sq_m;
    static constexpr units::kilogram_square_meter_t kDriveInertia =
        0.01_kg_sq_m;
