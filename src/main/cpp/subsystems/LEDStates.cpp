...
SolidColorState::SolidColorState(uint8_t r, uint8_t g, uint8_t b,
                                 double brightness, std::string name)
...
ErrorState::ErrorState(double speed) : m_speed(speed)
{
}
...
WarningState::WarningState(double speed) : m_speed(speed)
{
}
...
SuccessState::SuccessState(double speed) : m_speed(speed)
{
}
...
LEDStatePtr LEDStateFactory::CreateSolidColorState(uint8_t r, uint8_t g,
                                                   uint8_t b, double brightness,
