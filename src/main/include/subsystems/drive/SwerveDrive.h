...
namespace nfr
{
     ...
     * 
     * This gives incredible maneuverability - the robot can move in any direction
     * instantly without having to turn first, and can even spin while moving sideways!
     * 
     * ## Key Features:
     * - **Field-centric driving**: "Forward" always means away from your alliance wall
     * - **Autonomous path following**: Robot can follow pre-planned routes precisely
     * - **System identification**: Automatic tuning of control parameters
     * - **Advanced odometry**: Tracks robot position very accurately
     * - **Vision integration**: Can use camera data to improve position estimates
     * 
     * ## Inheritance Chain:
     * This class inherits from both:
     * - `SubsystemBase`: Integrates with WPILib's command system
     * - `SwerveDrivetrain`: Provides low-level swerve drive control from CTRE Phoenix
     * 
     * @note This uses CTRE Phoenix 6 hardware (TalonFX motors, CANcoder encoders)
     */
    ...
    private:
        ...
        // SysId helps automatically tune PID controllers by characterizing robot response
        
        /** @brief SysId request for measuring translation (drive) motor response */
         ...
         * 
         * This systematically applies different voltages to the drive motors and
         * measures the robot's response to automatically calculate optimal PID gains.
        ...
        frc2::sysid::SysIdRoutine sysIdRoutineTranslation{
            frc2::sysid::Config{
                ...
                {
                    // Log the test state so we can see progress in Phoenix Tuner
         ...
         * 
         * Similar to translation SysId, but tests the steering motors that rotate
         * each wheel to point in different directions.
         */
        ...
        frc2::sysid::SysIdRoutine sysIdRoutineRotation{
            ...
            frc2::sysid::Mechanism{
                [this](units::volt_t output)
                {
                    // Convert voltage to rotational rate (1V = 1 rad/s for this test)
         ...
         * regardless of which direction the robot is facing. Much easier for drivers!
         */
         ...
         * 
         * Robot-centric means "forward" is whatever direction the robot is currently
         * facing. Harder for drivers but sometimes useful for precise positioning.
         */
    ...
    public:
         ...
         * 
         * @param drivetrainConstants Basic drivetrain parameters (wheelbase, track width, etc.)
         * @param updateRate How often to recalculate motor commands (Hz)
         * @param odometryStandardDeviation Trust level for wheel-based position tracking
         * @param visionStandardDeviation Trust level for camera-based position tracking
         ...
         * @param frontLeftConstants Hardware configuration for front-left module
         * @param frontRightConstants Hardware configuration for front-right module
         * @param backLeftConstants Hardware configuration for back-left module
         * @param backRightConstants Hardware configuration for back-right module
         */
        ...
        /**
         * @brief Creates command from a function that returns a reference to a request
         * 
         * ## Template Explanation for Students:
         * This is a "template method" - it can work with many different types.
         * The `template <typename RequestSupplier>` means this method can accept
         * any function that returns a swerve drive request.
         * 
        ...
        /**
         * @brief Creates command from a function that returns a value (not reference)
         * 
         ...
         * 
         * ## Why Two Versions?
         * Sometimes you want to return a reference to an existing request object,
         * other times you want to create a new request object each time. Both
         * patterns are useful, so we support both.
         * 
         ...
         * 
         * @param sample Target pose, velocity, and timing from Choreo trajectory
         */
        ...
        /**
         * @brief Resets swerve module offsets and returns the calculated corrections
         * 
         ...
         * 
         * @param xAxis Function returning X-axis input (-1.0 to 1.0, positive = right)
         * @param yAxis Function returning Y-axis input (-1.0 to 1.0, positive = forward)
         * @param rotationAxis Function returning rotation input (-1.0 to 1.0, positive = counterclockwise)
         * @param fieldRelative If true, uses field-centric control; if false, robot-centric
